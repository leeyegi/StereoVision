...
ret_l, mtx_l, dist_l, rvecs_l, tvecs_l = cv2.calibrateCamera(objectPoints=_3d_points, imagePoints=_2d_points_left, imageSize=(1536,2048), cameraMatrix=None, distCoeffs=None)
ret_r, mtx_r, dist_r, rvecs_r, tvecs_r = cv2.calibrateCamera(objectPoints=_3d_points, imagePoints=_2d_points_right, imageSize=(1536,2048), cameraMatrix=None, distCoeffs=None)
